...
The purpose of the story time program is to generate a story, and print the story to the screen so that you can read it. So, a good way to start is understanding how to use the Python `print` function.
...
Now that you can print to the screen, you're ready to ask the user for input, so that you can find out a bit more about the dragon.

--- task ---
Create a new variable called `name` and use the `input` function to ask the user for the dragon's name. The name will be stored in your new variable.

...
The purpose of the story time program is to generate a story, and print the story to the screen so that you can read it. So, start by learning how to use the Python `print` function.
